...
const SYSTEM_DEFAULTS: Omit<BadgeConfigRow, "id" | "company_id" | "created_at">[] = [
  ...
  { badge_key: "top_3", name: "Top 3 Finish", description: "Ranked in top 3 in your unit", icon: "Trophy", color: "text-yellow-600 dark:text-yellow-400", rule_type: "rank_max", threshold: 3, streak_months: null, is_active: true, is_system: true, sort_order: 3 },
