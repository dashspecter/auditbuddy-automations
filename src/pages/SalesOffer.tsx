    ...
    <div className="min-h-screen bg-background flex items-center justify-center">
      <div className="text-center space-y-6 p-8">
        ...
        <div className="bg-muted/50 rounded-lg p-6 text-left max-w-md mx-auto space-y-2 text-sm">
          ...
          <p><span className="font-semibold text-primary">Final Price:</span> <span className="text-primary font-bold">1,240 EUR + VAT / month</span></p>
          <p><span className="font-semibold">Bonus:</span> All other restaurant modules + platform setup FREE</p>
        </div>

        <Button size="lg" onClick={generateProperPizzaOffer} className="gap-2">
