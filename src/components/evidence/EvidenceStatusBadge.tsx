...
interface EvidenceStatusBadgeProps {
  ...
  className?: string;
  size?: "sm" | "default";
  /** Set false to disable the explanatory tooltip */
  showTooltip?: boolean;
}

const tooltipText: Record<EvidenceStatus | "none", string> = {
  none: "No evidence has been submitted for this item.",
  draft: "Evidence is being prepared but has not been submitted yet.",
  submitted: "Proof submitted, waiting for a manager to approve or reject.",
  approved: "A manager has verified and accepted this evidence.",
  rejected: "A manager rejected this evidence. The task was reset to pending and the employee was notified.",
};

export function EvidenceStatusBadge({ status, className, size = "default", showTooltip = true }: EvidenceStatusBadgeProps) {
