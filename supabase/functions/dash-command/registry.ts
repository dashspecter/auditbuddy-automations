...
export const CAPABILITY_REGISTRY: Record<string, CapabilityEntry> = {
  ...
  workforce: {
    ...
    reads: ["search_employees", "get_employee_shifts", "get_attendance_exceptions", "get_attendance_summary", "get_training_gaps"],
  ...
  operations: {
    ...
    invalidateKeys: ["tasks", "work-orders", "team-stats", "documents", "alerts"],
  ...
  notifications: {
    ...
    invalidateKeys: ["pending-approvals", "notifications"],
